...
export const DEMO_ROUTES: DemoRoute[] = [
  {
    id: 'phoenix_downtown',
    name: 'Phoenix Downtown — Roosevelt Row',
    description: 'Exposed grid vs tree-lined Roosevelt + shaded light-rail corridor (USA heat capital)',
    origin: { lat: 33.4484, lng: -112.0740 },
    destination: { lat: 33.4620, lng: -112.0698 },
    profileId: 'elderly',
    expectedOutcome: 'Coolest route uses shaded 1st Ave + park detour — 4.2°C cooler, 55% more shade',
  },
  {
    id: 'nyc_midtown',
    name: 'NYC Midtown — Times Sq to Central Park',
    description: 'Sun-baked 7th Ave vs shaded side-streets + park paths',
    origin: { lat: 40.7580, lng: -73.9855 },
    destination: { lat: 40.7812, lng: -73.9665 },
    profileId: 'child',
    expectedOutcome: 'Balanced route cuts exposure 38% via 6th Ave park plazas',
  },
  {
    id: 'austin_soco',
    name: 'Austin SoCo — Heat Equity Corridor',
    description: 'I-35 frontage vs SoCo shade + Hays St trails (Justice40 tract)',
    origin: { lat: 30.2518, lng: -97.7499 },
    destination: { lat: 30.2672, lng: -97.7490 },
    profileId: 'outdoor_worker',
    expectedOutcome: 'Coolest saves 3.8°C by hugging east-side canopy — demo for equity pitch',
  },
];